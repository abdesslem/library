...
@Component({
    selector: 'jhi-commande-my-suffix',
    templateUrl: './commande-my-suffix.component.html'
})
export class CommandeMySuffixComponent implements OnInit, OnDestroy {
commandes: CommandeMySuffix[];
    ...
    loadAll() {
        this.commandeService.query().subscribe(
            (res: HttpResponse<CommandeMySuffix[]>) => {
    ...
    trackId(index: number, item: CommandeMySuffix) {
        return item.id;
    }
