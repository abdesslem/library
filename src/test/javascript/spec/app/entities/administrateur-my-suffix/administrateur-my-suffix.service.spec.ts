...
describe('Service Tests', () => {
    ...
    describe('AdministrateurMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(AdministrateurMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/administrateurs';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return AdministrateurMySuffix', () => {
