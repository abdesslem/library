...
public class CategorieResourceIntTest {
    ...
    private static final String DEFAULT_NOMCATEGORIE = "AAAAAAAAAA";
    private static final String UPDATED_NOMCATEGORIE = "BBBBBBBBBB";
    ...
    public void setup() {
        ...
        final CategorieResource categorieResource = new CategorieResource(categorieRepository, categorieMapper);
    ...
    public static Categorie createEntity(EntityManager em) {
        Categorie categorie = new Categorie()
            .nomcategorie(DEFAULT_NOMCATEGORIE)
    ...
    public void createCategorie() throws Exception {
        ...
        assertThat(testCategorie.getNomcategorie()).isEqualTo(DEFAULT_NOMCATEGORIE);
    ...
    public void getAllCategories() throws Exception {
        ...
        restCategorieMockMvc.perform(get("/api/categories?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].nomcategorie").value(hasItem(DEFAULT_NOMCATEGORIE.toString())))
    ...
    public void getCategorie() throws Exception {
        ...
        restCategorieMockMvc.perform(get("/api/categories/{id}", categorie.getId()))
            ...
            .andExpect(jsonPath("$.nomcategorie").value(DEFAULT_NOMCATEGORIE.toString()))
    ...
    public void updateCategorie() throws Exception {
        ...
        updatedCategorie
            .nomcategorie(UPDATED_NOMCATEGORIE)
        ...
        Categorie testCategorie = categorieList.get(categorieList.size() - 1);
        assertThat(testCategorie.getNomcategorie()).isEqualTo(UPDATED_NOMCATEGORIE);
